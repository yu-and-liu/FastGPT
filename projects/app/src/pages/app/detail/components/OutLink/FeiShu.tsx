...
import { defaultOutLinkForm, defaultFeishuOutLinkForm } from '@/constants/app';
import type {
  OutLinkEditType,
...
import { OutLinkConfigSchema } from '@fastgpt/global/support/outLinkConfig/type';
...
const FeiShu = ({ appId }: { appId: string }) => {
  ...
  const [editFeiShuLinkData, setEditFeiShuLinkData] = useState<OutLinkConfigEditType>();
  ...
  const {
    ...
    getShareChatList({ appId, type: OutLinkTypeEnum.feishu })
  );
                      ...
                      },
                      {
                        ...
                        onClick: () =>
                          setEditFeiShuLinkData({
                            ...
                            name: item.name,
                            limit: item.limit,
                            feiShuConfig: item.feiShuConfig
                          })
                      },
                      {
